...
saveRDS(random,"./Objects/FT_randomization_output.rds")
write.table(random,"./Objects/FT_randomization_output.csv", sep = ',', dec = ".", row.names = F)
...
# Save -----------------------------------------------------------------------------------------------
saveRDS(df,"./Objects/FT_randomization_CI.rds")
write.table(df,"./Objects/FT_randomization_CI.csv", sep = ',', dec = ".", row.names = F)
